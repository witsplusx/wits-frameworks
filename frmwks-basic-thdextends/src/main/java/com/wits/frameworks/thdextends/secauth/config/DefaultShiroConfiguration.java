...
import com.wits.frameworks.thdextends.secauth.service.DefaultAccountProvider;
 ...
 */
@Configuration
@ConditionalOnMissingBean(WitsShiroConfigurationAdapter.class)
public class DefaultShiroConfiguration extends WitsShiroConfigurationAdapter {
