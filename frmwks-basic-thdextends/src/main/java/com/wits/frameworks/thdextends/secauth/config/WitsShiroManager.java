...
import com.wits.frameworks.thdextends.secauth.authc.WitsModularRealmAuthenticator;
import com.wits.frameworks.thdextends.secauth.authc.WitsPasswdMatcher;
import com.wits.frameworks.thdextends.secauth.authc.WitsSubjectFactory;
import com.wits.frameworks.thdextends.secauth.cache.CacheDelegator;
import com.wits.frameworks.thdextends.secauth.cache.MapCacheManager;
import com.wits.frameworks.thdextends.secauth.cache.RedisCacheManager;
import com.wits.frameworks.thdextends.secauth.cache.SpringCacheManager;
import com.wits.frameworks.thdextends.secauth.filter.FilterManager;
import com.wits.frameworks.thdextends.secauth.handler.DefaultSessionListener;
import com.wits.frameworks.thdextends.secauth.realm.RealmManager;
...
import com.wits.frameworks.thdextends.secauth.util.ShiroUtils;
 ...
 */
public class WitsShiroManager {

	private static final Logger LOGGER = LoggerFactory.getLogger(WitsShiroManager.class);
	...
	private WitsPasswdMatcher passwdMatcher;
	...
	protected WitsShiroManager(BeanFactory beanFactory, ShiroProperties properties,
	...
	private void buildPasswdMatcher() {
		...
		WitsPasswdMatcher passwdMatcher = new WitsPasswdMatcher();
	...
	private void buildRealmManager() {
		...
		realmManager.setWitsPasswdMatcher(this.passwdMatcher);
	...
	private void buildSecurityManager(){
		...
		securityManager.setAuthenticator(new WitsModularRealmAuthenticator());
		...
		WitsSubjectFactory subjectFactory = new WitsSubjectFactory(storageEvaluator);
	...
	public WitsPasswdMatcher getPasswdMatcher() {
