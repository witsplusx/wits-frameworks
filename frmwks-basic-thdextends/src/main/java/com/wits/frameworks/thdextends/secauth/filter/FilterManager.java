...
import com.wits.frameworks.thdextends.secauth.config.IllegalConfigException;
...
import com.wits.frameworks.thdextends.secauth.filter.stateless.*;
import com.wits.frameworks.thdextends.secauth.model.AuthorizeRule;
import com.wits.frameworks.thdextends.secauth.model.CustomRule;
import com.wits.frameworks.thdextends.secauth.model.RolePermRule;
import com.wits.frameworks.thdextends.secauth.service.ShiroAccountProvider;
import com.wits.frameworks.thdextends.secauth.service.ShiroFilteRulesProvider;
...
public class FilterManager {
	...
	public void initFilters(){
		...
		WitsFormAuthenticationFilter formFilter = new WitsFormAuthenticationFilter();
		...
		WitsRolesAuthorizationFilter rolesFilter = new WitsRolesAuthorizationFilter();
		this.statefulFilters.putIfAbsent(Commons.FILTER_ROLES, rolesFilter);

		WitsPermissionsAuthorizationFilter permsFilter = new WitsPermissionsAuthorizationFilter();
		this.statefulFilters.putIfAbsent(Commons.FILTER_PERMS, permsFilter);

		WitsUserFilter userFilter = new WitsUserFilter();
