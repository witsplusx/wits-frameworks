...
public class SecurityManagerConfig {
	...
	/**
	 * 设置账号信息提供者
	 * @param accountProviderImpl  see org.jsets.shiro.appsvc.ShiroAccountProvider
	 */
	...
	/**
	 * 设置密码错误次数超限处理器
	 * @param passwdRetryLimitHandlerImpl  see org.jsets.shiro.appsvc.PasswdRetryLimitHandler
	 */
	 ...
	 *
	 * @param statelessAccountProviderImpl  see org.jsets.shiro.appsvc.ShiroStatelessAccountProvider
	 */
	 ...
	 * <br>如需要定制RememberMe Cookie的name、entity、httpOnly可设置此项
	 *
